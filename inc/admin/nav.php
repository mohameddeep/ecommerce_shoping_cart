  ...
  <ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown mt-2">
        ...
        <div class="dropdown-menu">
          <a class="dropdown-item" href="all_catogries.php">view Categories </a>
          <a class="dropdown-item" href="add_catogry.php">Add Categories</a> 
        </div>
      </li>
      ...
      <li class="nav-item dropdown mt-2">
        ...
        <div class="dropdown-menu">
          <a class="dropdown-item" href="all_products.php">view Products </a>
          <a class="dropdown-item" href="add_product.php">Add Products</a> 
        </div>
      </li>
      ...
      <li class="nav-item dropdown mt-2">
        ...
        <div class="dropdown-menu">
          <a class="dropdown-item" href="all_orders.php">view Orders </a>
          <a class="dropdown-item" href="add_order.php">Add Orders</a> 
        </div>
      </li>
      ...
      <li class="nav-item dropdown mt-2">
        ...
        <div class="dropdown-menu">
          ...
          <a class="dropdown-item" href="../../handelers/admin/logout.php">Logout</a> 
        </div>
      </li>
